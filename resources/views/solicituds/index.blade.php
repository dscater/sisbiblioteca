...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Solicitudes de Préstamo</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">Inicio</a></li>
                    <li class="breadcrumb-item active">Solicitudes de Préstamo</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        {{-- <a href="{{route('solicituds.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> Nuevo</a> --}}
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
...
<script>
    ...
    $(document).on('click','table tbody tr td.btns-opciones a.eliminar',function(e){
        ...
        $('#mensajeEliminar').html(`¿Está seguro(a) de eliminar la solicitud del lector <b>${solicitud}</b>?<h4>Esta acción no se podra deshacer después</h4>`);
