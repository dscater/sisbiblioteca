            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Modificar editorial</h3>
                    </div>
                    <!-- /.card-header -->
                    <form action="{{route('editorials.update',$editorial->id)}}" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            {{ method_field('PUT') }}
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="descripcion" value="{{$editorial->descripcion}}" class="form-control">
                                    </div>
                                </div>
                            </div>
