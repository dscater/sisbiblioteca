                                    ...
                                    @foreach ($solicituds as $solicitud)
                                        <tr>
                                            ...
                                            <td class="btns-opciones">
                                                @if (Auth::user()->tipo == 'ADMINISTRADOR')
                                                    <a href="#"
                                                        data-url="{{ route('solicituds.destroy', $solicitud->id) }}"
    ...
    <script>
        ...
        $(document).on('click', 'table.data-table1 tbody tr td.btns-opciones a.eliminar', function(e) {
            ...
            $('#mensajeEliminar').html(
                `¿Está seguro(a) de eliminar la solicitud del lector <b>${solicitud}</b>?<h4>Estación no se podra deshacer después</h4>`
            );
