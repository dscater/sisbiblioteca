            ...
            <div class="row">
                <div class="col-md-6 mr-auto ml-auto">
                    <div class="input-group">
                        <input type="text" name="buscador" id="buscador" class="form-control" autofocus placeholder="Buscar" required>
                ...
                <div class="col-md-3">
                    <div class="contenedor">
                        ...
                        <div class="opciones">
                            ...
                            @else
                            <a href="" data-id="{{$libro->id}}" class="reservar btn bg-navy btn-sm" style="color:white!important;">RESERVAR</a>
                            @endif
