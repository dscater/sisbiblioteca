            ...
            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="card-body" style="overflow:hidden">
                            <div class="image-area">
                                <img id="imagen_p" src="{{ asset('imgs/users/' . $user->foto) }}" alt="Imagen de perfil"
                                    width="128px" height="128px" />
                            </div>
                            <div class="content-area">
                                <form action="post" action="{{ route('users.config_update_foto', Auth::user()->id) }}"
                                    class="form-horizontal" id="form_foto" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-12">
                ...
                <div class="col-xs-12 col-sm-8">
                    <div class="card">
                        <div class="card-body">
                            <div>
                                <form action="post" action="{{ route('users.config_update', Auth::user()->id) }}"
                                    class="form-horizontal" id="form_val">
                                    @csrf
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="password" class="form-control" id="OldPassword"
                                                        name="oldPassword" placeholder="Antigua contraseña" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="password" class="form-control" id="NewPassword"
                                                        name="newPassword" placeholder="Nueva contraseña" minlength="6"
                                                        required>
                                                </div>
