                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Paterno*</label>
                                            <input type="text" name="paterno" value="{{ $usuario->paterno }}"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Materno</label>
                                            <input type="text" name="materno" value="{{ $usuario->materno }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>C.I.*</label>
                                            <input type="number" name="ci" value="{{ $usuario->ci }}"
                                                class="form-control" required>
                                            @if ($errors->has('ci'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="dir" value="{{ $usuario->dir }}"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fono" value="{{ $usuario->fono }}"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Celular*</label>
                                            <input type="text" name="cel" value="{{ $usuario->cel }}"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="familiar" value="{{ $usuario->familiar }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cel_f" value="{{ $usuario->cel_f }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
