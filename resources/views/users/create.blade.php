                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select name="ci_exp" id="ci_exp" id="" class="form-control"
                                                required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fono" value="{{ old('fono') }}"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Celular*</label>
                                            <input type="text" name="cel" value="{{ old('cel') }}"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cel_f" value="{{ old('cel_f') }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
